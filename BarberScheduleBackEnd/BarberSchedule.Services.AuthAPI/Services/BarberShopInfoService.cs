...
namespace BarberSchedule.Services.AuthAPI.Services
{
    public class BarberShopInfoService : IBarberShopInfoService
    {
        ...
        public async Task<bool> CreateBarberShop(CreateBarberShopInfoDto barberShopInfoModel)
        {
        ...
        public async Task<BarberShopInfoDto?> GetBarberShopInfo(UserModel barberShop)
        {
