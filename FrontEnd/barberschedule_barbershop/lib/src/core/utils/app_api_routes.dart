abstract class AppApiRoutes {
  ...
  static String registerBarberShop() {
    return '${_authApiUrl}auth/register/client';
  }

  static String loginBarberShop() {
    return '${_authApiUrl}auth/login/barberShop';
  }
  ...
  static String getAllPaymentMethods() {
    return '${_barberShopApiUrl}PaymentMethods/GetAll';
  }
}
